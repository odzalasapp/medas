...
FiltrerZones <- function( 
  cheminFichierContoursSHP,
  depcom)
{
  
  carreaux <- data.table::fread(Filosofi2015_carreaux_200m_metropole) %>%
...
# L’utilisateur doit disposer d’un contour géographique de sa zone (format shapefile).
